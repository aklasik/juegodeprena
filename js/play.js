playGame={
    ...
    button=game.add.button(300,60,"pig1",this.pushUp);
    button=game.add.button(300,415,"pig2",this.pushDown);
    button=game.add.button(550,255,"pig3",this.pushRight);
    button=game.add.button(50,255,"pig4",this.pushLeft);

	},
	update:function(){
      if(keyboard.left.isDown){
        player.animations.play('pig4');
    }
    else if(keyboard.right.isDown){
        player.animations.play('pig3');
    }
    else if(keyboard.up.isDown){
        player.animations.play('pig1');
    }
    else if(keyboard.down.isDown){
        player.animations.play('pig2');
    }
    else{
    ...
    paltik = game.add.button(380,350,'paltik', playGame.paltikLamet);
    }
    else if(pointer.body.x==100 || pointer.body.x <  200){
        kamay = game.add.image(250,250,"kamay2");
    gameover = game.add.button(380,350,'gameover', playGame.gameoverLamet);
    }
 ...
 pushLeft:function(){pointer.body.velocity.x = 0;
    ...
    else if(pointer.body.x==100 || pointer.body.x <  100){
        a = a + 1;
        score.text="Score :"+a;
        kamay = game.add.image(250,250,"kamay");
    paltik = game.add.button(380,350,'paltik', playGame.paltikLamet);
 ...
 pushDown:function(){pointer.body.velocity.x = 0;
    ...
    else if(pointer.body.x==200 || pointer.body.x <  100){
        a = a + 1;
        score.text="Score :"+a;
        kamay = game.add.image(250,250,"kamay");
    paltik = game.add.button(380,350,'paltik', playGame.paltikLamet);}
